...
#define EASTL_MACRO_SWAP(Type, a, b) \
    ...
    protected:
        iterator DoGetResultIterator(true_type, const insert_return_type &irt)  const EA_NOEXCEPT
        {
            return irt.first;
        }
        iterator DoGetResultIterator(false_type, const insert_return_type &irt) const EA_NOEXCEPT
        {
            return irt;
        }
