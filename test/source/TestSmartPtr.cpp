...
namespace SmartPtrTest
{
    ...
    struct CustomDeleter {
        ...
        CustomDeleter &operator=(CustomDeleter &&)
        {
            return *this;
        }
#endif
    ...
    struct CustomArrayDeleter {
        ...
        CustomArrayDeleter &operator=(const CustomArrayDeleter &)
        {
            return *this;
        }
        CustomArrayDeleter &operator=(CustomArrayDeleter &&)
        {
            return *this;
        }
#endif
    ...
    struct NamedClass {
        ...
        NamedClass(const char *pName = NULL)
            : mpName(pName), mpName2(NULL)
        {
            ++mnCount;
        }

        NamedClass(const char *pName, const char *pName2)
            : mpName(pName), mpName2(pName2)
        {
            ++mnCount;
        }

        NamedClass(const NamedClass &x)
            : mpName(x.mpName), mpName2(x.mpName2)
        {
            ++mnCount;
        }
    ...
    public:
        ...
        ACLS(int _a_ = 0) : a(_a_)
        {
            ++mnCount;
        }
        ACLS(const ACLS &x) : a(x.a)
        {
            ++mnCount;
        }
        ACLS &operator=(const ACLS &x)
        {
            a = x.a;
            return *this;
        }
    ...
    public:
        ...
        BCLS(int _b_ = 0) : b(_b_)
        {
            ++mnCount;
        }
        BCLS(const BCLS &x) : ACLS(x), b(x.b)
        {
            ++mnCount;
        }
        BCLS &operator=(const BCLS &x)
        {
            b = x.b;
            ACLS::operator=(x);
            return *this;
