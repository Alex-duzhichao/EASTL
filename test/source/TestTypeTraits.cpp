...
bool operator ==(const PodA &a1, const PodA &a2)
{
    return (a1.mX == a2.mX);
}
...
struct HasIncrementOperator {
    HasIncrementOperator &operator++()
    {
        return *this;
    }
};
...
private:
    ConstructibleOnlyWithNonConstReference(const ConstructibleOnlyWithNonConstReference &) {}
#else
